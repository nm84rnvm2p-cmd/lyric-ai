...
def draw_intro_frame(
    ...
    if logo is not None:
        ...
        # Logo fica presente principalmente
        # antes da expansão.
...
def choose_blue_indexes(
    ...
    # palavra azul em frases maiores.
...
def draw_text_with_alpha(
    ...
    # Cria somente uma pequena camada
    # ao redor da palavra.
    # Isso evita deixar o render pesado.
